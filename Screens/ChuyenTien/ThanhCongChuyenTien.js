...
export default class ThanhCongChuyenTien extends Component {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.center0}>
                    <Text style={{ fontWeight: '700', marginTop: 10, fontSize: 16, textAlign: 'center' }}>Bạn đã chuyển tiền thành công đến Huynh Ngoc Liem (0344048137)</Text>
                </View>
