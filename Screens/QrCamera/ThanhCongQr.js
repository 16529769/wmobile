...
export default class ThanhCongQr extends Component {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.center0}>
                    <Text style={{ fontWeight: '700', marginTop: 10, fontSize: 16, textAlign: 'center' }}>Bạn đã thanh toán hóa đơn hợp đồng trả góp FE-Credit</Text>
                </View>
