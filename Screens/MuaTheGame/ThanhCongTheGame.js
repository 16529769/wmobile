        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.center0}>
                    <Text style={{  fontWeight: '700', marginTop: 10,fontSize:16,textAlign:'center'}}> Bạn đã mua thành công mã thẻ K Card mệnh giá 10.000đ </Text>
                </View>
                <View style={styles.center}>
                    ...
                    <View style={styles.center1}>
                        ...
                        <Text style={{fontSize:16,color:'green'}}>9382371827381</Text>
                    </View>
                    <View style={styles.center1}>
                        <Text style={styles.txt1}>Số serial </Text>
                        <Text style={{fontSize:16,color:'green'}}>CGA44wC</Text>
                    </View>
